    ...
    return (
        <motion.div className="contact" variants={variants} initial="hidden" whileInView="visible">
            ...
            <motion.div className="formContainer" variants={variants}>
                <motion.div className="messageSvg" initial={{ opacity: 1 }} whileInView={{ opacity: 0 }} transition={{ delay: 3, duration: 2 }}>
                    <svg fill="#2a2a2a" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 490.282 490.282" xml:space="preserve"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier"></g><g id="SVGRepo_iconCarrier"><g><motion.path initial={{ pathLength: 0 }}
