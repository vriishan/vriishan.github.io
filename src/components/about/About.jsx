        ...
        <div className="content">
          ...
          <div className="textContainer">
            <div className="description">
              ...
              <p>When I'm away from my keyboard, you can find me jamming away at my piano, hiking away in the Los Angeles hills or catching the latest sci-fi action movie!</p>
            </div>
